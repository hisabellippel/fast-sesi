...
// Correção do Warning: Undefined array key, checando se a chave existe antes de acessar.
...
<head>
    ...
    <style>
        ...
        .botoes-crud button, .btn-adicionar { 
            padding: 8px 12px; 
            border: none; 
            border-radius: 5px; /* Padrão aplicado a todos os botões CRUD e Adicionar */
            cursor: pointer; 
            font-weight: bold; 
        ...
        /* Botão Editar no mesmo padrão do Excluir */

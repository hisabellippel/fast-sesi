...
<br>
    <main>
        ...
        Os dados da linha 4 foram atualizados!
        </div>
        ...
        <img src="../asets/imagens/meio/linha4.png" height= "150px" width="370" alt="">
            ...
            <div class="passageiros">
                <p>Passageiros em tempo real: <p class="numero-vermelho"> 545 </p></p>
            </div>

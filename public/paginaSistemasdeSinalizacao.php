    ...
    <main>
        ...
        <br>
         ...
         <form action="pesquisa.php" method="get" class="form-pesquisa" autocomplete="off">
            ...
            <div class="lado">
                <div class="red000">
                    <img src="../asets/imagens/meio/sinaleiro.png" alt="" height= "60px" width= "60px">
                    <a href="paginaSinaleiros.php"><p class="cormenu">Sinaleiros</p></a>
                </div>

                <div class="red1111">
                    <img src="../asets/imagens/meio/placa.png" alt="" height= "70px" width= "70px">
                    <a href="paginaPlacasSinalizar.php"><p class="cormenu">Placas de Sinalização</p></a>
                </div>
            </div>
            <div class="lado">
                <div class="red2222">
                    <img src="../asets/imagens/meio/cbtc.png" alt="" height= "50px" width= "60px">
                    <a href="paginaCBTC.php"><p class="cormenu">CBTC</p></a>
                </div>

                <div class="red3333">
                    <img src="../asets/imagens/meio/intertravamento.png" alt="" height= "60px" width= "70px">
